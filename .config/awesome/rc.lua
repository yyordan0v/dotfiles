...
awful.spawn(
    "xrandr --output DisplayPort-0 --mode 1920x1080 --pos 1292x0 --rotate normal --output DisplayPort-1 --primary --mode 2560x1440 --pos 972x1080 --rotate normal --output HDMI-A-0 --off --output HDMI-A-1 --off --output DVI-D-0 --off")
